...
INSERT INTO app_user (user_id, username, password_hash, role, doctor_id, patient_id, is_active) VALUES
 (1,'admin',       '$2b$10$placeholderhashadminxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','ADMIN',NULL,NULL,TRUE),
 (2,'dr.tanvir',   '$2b$10$placeholderhashdoc1xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','DOCTOR',1,NULL,TRUE),
 (3,'dr.razia',    '$2b$10$placeholderhashdoc2xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','DOCTOR',2,NULL,TRUE),
 (4,'reception1',  '$2b$10$placeholderhashrecpxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','RECEPTIONIST',NULL,NULL,TRUE),
 (5,'pharm.rubel', '$2b$10$placeholderhashpharxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','PHARMACIST',NULL,NULL,TRUE),
 (6,'lab.faruque', '$2b$10$placeholderhashlabxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','LAB_TECH',NULL,NULL,TRUE),
 (7,'patient.rakib','$2b$10$placeholderhashpat1xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','PATIENT',NULL,1,TRUE);
